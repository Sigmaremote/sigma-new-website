...
const content = countryContent.argentina;
const argentinaData = countryIndexList.find(country => country.slug === 'argentina');
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://country-guide.sigmaremote.com/country-guides/argentina',
  },
  openGraph: {
    title: content.hero?.title || `Hiring in ${content.name}: Payroll, Compliance, and Employer Costs`,
    description: content.intro,
    type: 'article',
    url: 'https://country-guide.sigmaremote.com/country-guides/argentina',
    images: [
      {
        url: '/api/og?title=Argentina%20Hiring%20Guide',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: content.hero?.title || `Hiring in ${content.name}: Payroll, Compliance, and Employer Costs`,
    description: content.intro,
    images: ['/api/og?title=Argentina%20Hiring%20Guide'],
  },
};
    ...
    <>
      ...
      <CountryGuideLayout tocItems={tocItems}>
        <div className="max-w-[820px] mx-auto space-y-10 md:space-y-14">
          ...
          <CountryHero 
            content={content} 
            heroImage={argentinaData?.image || "https://images.unsplash.com/photo-1516026672322-bc52d61a55d5?w=800&h=600&fit=crop&crop=center"}
          />
