...
export const countryContent: Record<string, CountryGuideContent> = {
  mexico: {
    ...
    atAGlance: {
      ...
      payrollCycle: 'Semi-monthly (15th/30th)',
      employerOnCostPct: '~25-30%',
      annualLeaveDays: 12,
      publicHolidays: 7,
      hoursPerWeek: '48 (reducing to 44 from July 15, 2025)',
  ...
  colombia: {
    ...
    atAGlance: {
      ...
      payrollCycle: 'Monthly (in arrears, last working day)',
      employerOnCostPct: '~29-32%',
      annualLeaveDays: 15,
      publicHolidays: 18,
      hoursPerWeek: '42 hours (effective July 2025)',
      thirteenthSalary: 'Yes (ordinary salaries <COP 18.5M)',
